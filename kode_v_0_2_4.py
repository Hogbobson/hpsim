...
def sym1(ensemble,dt):
    def drift(ensemble,dt): #I wish to make these more general
        ensemble.r = ensemble.r + dt*ensemble.v
        ensemble.d = distances(ensemble.r)
    
    def kick(ensemble):
        ensemble.v = ensemble.v + dt*acceleration(ensemble)
